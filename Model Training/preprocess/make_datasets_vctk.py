...
def read_filenames(root_dir):
    ...
    for path in sorted(glob.glob(os.path.join(root_dir, '*/*'))):
        ...
        speaker_id, utt_id = re.search(r'p(\d+)_(\d+)\.wav', filename).groups()
...
if __name__ == '__main__':
    ...
    data_dir = 'E:/VCTK/VCTK-Corpus/wav48'
    speaker_info_path = 'E:/VCTK/VCTK-Corpus/speaker-info.txt'
    output_dir = 'C:/Users/rohan/Desktop/OneshotVoiceConversionProject/adaptive_voice_conversion-master/DATA'
    test_speakers = 20
    test_proportion = 0.1
    sample_rate = 24000
    n_utts_attr = 5000
